...
- The website is deployed. Survey deployment, real Sheet writes, Search Console setup, console listing updates, store submission and public v1.2.0 extension availability remain unconfirmed. Website acceptance remains open until the analytics fix is deployed and reporting is verified.
