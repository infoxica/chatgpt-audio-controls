...
Please provide a summary of the change, including motivation, context, and any dependencies.
...
- [ ] 💄 UI/UX improvement or styling refinement
...
- [ ] My code adheres to the project's privacy-first policy (no external tracking or telemetry).
